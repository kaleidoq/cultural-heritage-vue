...
var _chat = _interopRequireDefault(__webpack_require__(/*! ./pages/paper/chat.vue */ 230));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // @ts-ignore
...
/* harmony import */ var _chat_vue_vue_type_template_id_3a52adb4_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chat.vue?vue&type=template&id=3a52adb4&scoped=true& */ 231);
/* harmony import */ var _chat_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chat.vue?vue&type=script&lang=js& */ 233);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _chat_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _chat_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _chat_vue_vue_type_style_index_0_id_3a52adb4_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chat.vue?vue&type=style&index=0&id=3a52adb4&lang=scss&scoped=true& */ 235);
...

{
  ...
  sockets: {
    ...
    broadcast_msg: function broadcast_msg(data) {
  ...
  methods: {
    ...
    // },
    // 发送消息
    submit: function submit(content) {var _this4 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var obj, message, res;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
                obj = {
                  user_id: 1,
                  ...
                  content: content,
                  // type: 'text',
                  send_time: _this4.$u.timeFormat(new Date(), 'yyyy-mm-dd hh:MM:ss') };

                message = {
                  content: content,
                  list_id: _this4.list_id,
                  another_id: _this4.anothUser.user_id };

                _this4.$socket.emit('sendMessage', message);_context3.next = 5;return (
                  (0, _paper.submitChat)(message));case 5:res = _context3.sent;
                console.log(res);
                if (res.code == 0) {
                ...
                } else _this4.$u.toast("消息发送失败");case 8:case "end":return _context3.stop();}}}, _callee3);}))();
    },
    // 滚动到底部
